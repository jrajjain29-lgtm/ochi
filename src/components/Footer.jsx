...
const Footer = () => {
  return (
    <div className='w-full h-screen flex p-20 rounded-2xl'>
      <div className='w-1/2  font-["Founders_Grotesk"] flex flex-col justify-between -mb-[10vh]'>
        <div className='headings'>
            <h1 className='pt-[2vw] uppercase scale-y-[1.5] leading-[0.9] font-bold text-[6vw] '>EYE -</h1>
            <h1 className='pt-[2vw] uppercase scale-y-[1.5] leading-[0.9] font-bold text-[6vw] '>OPENING</h1>
        </div>
      ...
      <div className='w-1/2 -mb-[10vh]'>
        <h1 className='pt-[2vw] uppercase scale-y-[1.5] leading-[0.9] font-bold text-[6vw] font-["Founders_Grotesk"] '>presentations</h1>
        <div className='mt-10'>
          <a href="#" className='block text-xl font-light underline-offset-5 underline'>Instagram</a>
          <a href="#" className='block text-xl font-light underline-offset-5 underline'>Facebook</a>
          <a href="#" className='block text-xl font-light underline-offset-5 underline'>Whatsapp</a>
          <a href="#" className='block text-xl font-light underline-offset-5 underline'>Twitter</a>
        </div>
      </div>
